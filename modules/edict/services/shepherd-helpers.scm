...
;;;
;;; shepherd-helpers.scm — Utility for creating standard Shepherd services.
;;;
;;; Adapted from nehrbash's shepherd-helpers.scm for the edict feature
;;; engine.  Provides a convenience wrapper around shepherd-service
;;; with auto-logging, respawn, and forkexec semantics.

(define-module (edict services shepherd-helpers)
