...
;;;
;;; packages/fonts.scm — Custom font packages for Caelestia.
;;;
;;; These are not (yet) in upstream Guix.  Adapted from nehrbash's
;;; packages/fonts.scm.

(define-module (edict packages fonts)
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "02khnxn807785f01zh59022b2r47rcy29xagsbhhyhws9777jdm0"))))
    (build-system font-build-system)
    (arguments
     '(#:phases
       (modify-phases %standard-phases
